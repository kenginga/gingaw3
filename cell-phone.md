      ...
      <article class="col-md-4">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <ol>
              <li><strong><span style="font-size: 200%; font-size: 200%; background: linear-gradient(transparent 60%, #ffff66 60%); position: relative">電話回線<img href="{{ {{ site.baseurl }}/images/kono-3-tsu.svg" alt="" style="position: absolute; top: 10px; left: 10px;"></span></strong></li>
